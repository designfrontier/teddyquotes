var action = function(){
        var action = {
                eventMe: function(objectIn){
                        ...
                        returnObject.dependencies = function(requiredIn, callbackIn, context){
                            var requiredInz = required //The array of dependencies
                            ...
                            closureFunction = function(){
                                ...
                                for(index = 0; index < required.length; index++){
                                    if(!required[index].isReady() && !required[index].isPending()){
